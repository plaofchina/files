;(function(window, $) {
  ...
  var indexSuperise = function(settings) {
    this.defaults = {
      ...
      smallMove: 'shake', // 长存小图动效 shake/rubberBand/jello/tada/flash
      smallMoveTime: 7000,
    ...
    var trackHtml = defaults.trackSuperId ? 'data-track-click=\'{"mod":"kp_popu_' + defaults.trackSuperId + '","con":"' + defaults.link + ',-"}\'' : '';
    var ispStyle = '<link href="//csdnimg.cn/public/common/indexSuperise/indexSuperise.css?20181024135400" rel="stylesheet">';
